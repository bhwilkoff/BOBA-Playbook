...
<!-- Merge these into the DualAppTemplate DECISIONS.md in the BOBACardApp repo -->
...
**Date:** 2026-04-03
**Display name:** BOBA Playbook. **Repo/Xcode name:** BOBACardApp (Xcode Cloud requires no spaces, and this matches the GitHub repo name).
