...
- [ ] When BoBA publishes art (likely on bobattlearena.com/explore/world-champions or bazookavault), trigger an image-sourcing pass — fastest is to point the existing BV scraper at the OKC-specific card pages
