  ...
  function renderModal() {
    box.innerHTML = `
      ...
      <div class="auth-modal-inner">
        ...
        <button class="btn-google-signin" id="auth-google-btn" type="button">
          <!-- Google "G" multi-color glyph; standard Google brand asset. -->
    ...
    box.querySelector('#auth-google-btn').addEventListener('click', () => {
      API.authSignInWithGoogle();
    });
